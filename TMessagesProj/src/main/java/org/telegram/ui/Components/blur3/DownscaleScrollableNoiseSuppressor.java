...
public class DownscaleScrollableNoiseSuppressor {
    ...
    public DownscaleScrollableNoiseSuppressor(boolean simple, boolean allowNoiseSuppress) {
        this(simple, allowNoiseSuppress, false);
    }

    public DownscaleScrollableNoiseSuppressor(boolean simple, boolean allowNoiseSuppress, boolean liquidGlassCapable) {
        isLiquidGlassEnabled = liquidGlassCapable || LiteMode.isEnabled(LiteMode.FLAG_LIQUID_GLASS);
        simpleMode = simple;
