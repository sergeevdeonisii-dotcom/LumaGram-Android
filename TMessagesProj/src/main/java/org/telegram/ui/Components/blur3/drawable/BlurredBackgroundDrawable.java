...
public abstract class BlurredBackgroundDrawable extends Drawable {
    public BlurredBackgroundDrawable() {
        ...
        boundProps.liquidIntensity = 0.88f * LiteMode.getLiquidGlassIntensityScale();
    ...
    public void setIntensity(float intensity) {
        boundProps.liquidIntensity = intensity * LiteMode.getLiquidGlassIntensityScale();
        onBoundPropsChanged();
    }
    ...
    protected static class Props {
        ...
        public float liquidIntensity = 0.88f;
