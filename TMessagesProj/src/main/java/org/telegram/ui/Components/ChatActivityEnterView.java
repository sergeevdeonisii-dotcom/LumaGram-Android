...
//                    list.add(2);
    ...
    public ChatActivityEnterView(Activity context, SizeNotifierFrameLayout parent, ChatActivity fragment, final boolean isChat, Theme.ResourcesProvider resourcesProvider) {
        ...
        messageEditTextContainer.addView(emojiButton, LayoutHelper.createFrame(DEFAULT_HEIGHT, DEFAULT_HEIGHT, Gravity.BOTTOM | Gravity.RIGHT, 0, 0, 8, 0));
        ...
        if (isChat) {
            ...
            attachButton = new ImageView(context) {
                ...
                @Override
                public void setAlpha(float alpha) {
                    super.setAlpha(shouldKeepLumaAttachButtonVisible() ? 1f : alpha);
                }

                @Override
                public void setScaleX(float scaleX) {
                    super.setScaleX(shouldKeepLumaAttachButtonVisible() ? 1f : scaleX);
                }

                @Override
                public void setScaleY(float scaleY) {
                    super.setScaleY(shouldKeepLumaAttachButtonVisible() ? 1f : scaleY);
                }
            };
            ...
            messageEditTextContainer.addView(attachButton, LayoutHelper.createFrame(DEFAULT_HEIGHT, DEFAULT_HEIGHT, Gravity.BOTTOM | Gravity.LEFT));
        ...
        audioVideoButtonContainer = new FrameLayout(context) {
            ...
            protected void dispatchDraw(@NonNull Canvas canvas) {
                if (!audioVideoButtonContainerForbidden) {
                    ...
                    final float diameterDp = LiteMode.isEnabled(LiteMode.FLAG_LIQUID_GLASS)
                        ? 36f + LiteMode.getLiquidGlassInputSizeLevel() : 38f;
                    final float r = dpf2(diameterDp / 2f);
                    paint.setColor(getThemedColor(Theme.key_chat_messagePanelSend));
                    final float margin = dpf2((DEFAULT_HEIGHT - diameterDp) / 2f);
                    final float height = dpf2(diameterDp);
                    final float width = dpf2(diameterDp);
                    backgroundRect.set(
...
//            }
    ...
    public void setBotWebViewButtonOffsetX(float offset) {
        ...
        if (messageEditText != null) {
            ...
            // the WebView button. Moving the text layer as well leaves the hint
            // noticeably too far to the right, especially in bot chats.
...
//        });
    ...
    private void createMessageEditText() {
        ...
        messageEditTextContainer.addView(messageEditText, 1, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT, Gravity.BOTTOM, 66, 0, isChat ? 60 : 2, 1.5f));
        ...
        messageEditTextContainer.addView(richDraftPreview, 2, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT, Gravity.BOTTOM, 66 - 8, 0, (isChat ? 60 : 2) - 8, 1.5f));
        emojiButton.bringToFront();
    ...
    private void updateFieldRight(int attachVisible) {
        ...
        if (isStories && isLiveComment) {
            ...
            if (botButton != null && botButton.getVisibility() == VISIBLE && scheduledButton != null && scheduledButton.getVisibility() == VISIBLE && attachButton != null && attachButton.getVisibility() == VISIBLE) {
                layoutParams.rightMargin = dp(156);
                ...
                layoutParams.rightMargin = dp(108);
            } else {
                layoutParams.rightMargin = dp(60);
            }
        } else {
        ...
        if (isChat) {
            layoutParams.rightMargin = Math.max(layoutParams.rightMargin, dp(60));
        }
...
//        }
    ...
    private void createRecordPanel() {
        ...
        recordDot.setTranslationX(-dp(5));
        recordTimeContainer.addView(recordTimerView = new TimerView(getContext()), LayoutHelper.createLinear(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT, Gravity.CENTER_VERTICAL, 19, 0, 0, 0));
    ...
    public View getBotCommandsMenuButton() {
        return botCommandsMenuButton;
    }
...
//                }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (botCommandsMenuButton != null && botCommandsMenuButton.getTag() != null) {
            ...
            if (messageEditText != null) {
                ((MarginLayoutParams) messageEditText.getLayoutParams()).leftMargin = dp(68) + width;
            }
            if (richDraftPreview != null) {
                ((MarginLayoutParams) richDraftPreview.getLayoutParams()).leftMargin = dp(68) + width;
            }
        } else {
            ...
            if (richDraftPreview != null) {
                ((MarginLayoutParams) richDraftPreview.getLayoutParams()).leftMargin = dp(64);
            }
        }
        updateBotCommandsMenuContainerTopPadding();
        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
...
//            }
    ...
    private boolean shouldKeepLumaAttachButtonVisible() {
        return isChat
            && !recordingAudioVideo
            && editingMessageObject == null
    ...
    private void updateAttachButtonTranslationX() {
        ...
        if (shouldKeepLumaAttachButtonVisible()) {
