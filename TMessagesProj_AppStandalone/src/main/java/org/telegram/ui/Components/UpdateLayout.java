...
/** Update banner backed by the custom Luma update channel. */
public class UpdateLayout extends IUpdateLayout {
    ...
    public void updateFileProgress(Object[] args) {
        if (updateLayout == null || updateTextView == null) {
            return;
        }
    ...
    public void createUpdateUI(int currentAccount) {
        ...
        updateLayout.setOnClickListener(v -> {
            if (updateLayoutIcon.getIcon() == MediaActionDrawable.ICON_DOWNLOAD) {
                ...
                if (file != null) {
                    AndroidUtilities.openForView(file, "Luma.apk", "application/vnd.android.package-archive", activity, null, false);
                }
            }
        });
        ...
        updateTextView.setText(LocaleController.getString(R.string.LumaUpdatesTitle), false);
    ...
    public void updateAppUpdateViews(int currentAccount, boolean animated) {
        ...
        if (ApplicationLoader.applicationLoaderInstance.getUpdate() != null) {
            ...
            if (file != null && file.exists()) {
                ...
                setUpdateText(LocaleController.getString(R.string.LumaUpdatesTitle), animated);
            }
    ...
    private void setUpdateText(String text, boolean animated) {
