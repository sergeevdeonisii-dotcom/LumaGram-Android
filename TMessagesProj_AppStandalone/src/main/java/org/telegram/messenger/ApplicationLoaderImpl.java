...
public class ApplicationLoaderImpl extends ApplicationLoader {
    ...
    public void checkUpdate(boolean force, Runnable whenDone) {
        LumaUpdaterController.getInstance().checkForUpdate(force, whenDone);
    }

    @Override
    public void downloadUpdate() {
        LumaUpdaterController.getInstance().downloadUpdate();
    }
    ...
    public boolean isDownloadingUpdate() {
        return LumaUpdaterController.getInstance().isDownloading();
    }

    @Override
    public float getDownloadingUpdateProgress() {
        return LumaUpdaterController.getInstance().getDownloadingProgress();
    }

    @Override
    public File getDownloadedUpdateFile() {
        return LumaUpdaterController.getInstance().getDownloadedFile();
    }
